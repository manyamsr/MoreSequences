...
def run_test_pizza():
    ...
    pizza(window, circle, 50, 'black', 3)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # Tests 3:
    title = 'POLYGON test 3:  5 segments with thin green lines'
    window = rg.RoseWindow(550, 400, title)
    circle = rg.Circle(rg.Point(100, 100), 80)
    circle.outline_thickness = 3
    polygon(window, circle, 5, 'green', 3)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  40 purple lines on orange circle, hops = 10.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(240, 165), 150)
    circle.fill_color = 'orange'
    fancy_polygon(window, circle, 40, 10, 'purple', 5)
    window.close_on_mouse_click()
